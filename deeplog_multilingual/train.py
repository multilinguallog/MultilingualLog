...
if __name__ == '__main__':
    ...
    parser.add_argument('--current-host', type=str, default='127.0.0.1',
                        help='args for SageMaker distributed training.')
    parser.add_argument('--model-dir', type=str, default='./model/Spark/Mix/',
                        help='the place where to store the model parameter.')
    parser.add_argument('--data-dir', type=str, default='./data/Spark/Mix/',
    ...
    if not os.path.isdir('./model/Spark/Mix/'):
        os.mkdir('./model/Spark/Mix/')
