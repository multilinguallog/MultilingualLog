...
if __name__ == '__main__':
    train_df = pd.read_csv(f'./data/HPC/Mix/HPC_mixed_train.log_structured.csv')
    test_df = pd.read_csv(f'./data/HPC/Mix/HPC_mixed_test.log_structured.csv')
    ...
    deeplog_train = deeplog_df_transfer_HPC(train_df, event_id_map)
    deeplog_file_generator('./data/HPC/Mix/train', deeplog_train)

    deeplog_test = deeplog_df_transfer_HPC(test_df, event_id_map)
    deeplog_file_generator('./data/HPC/Mix/test', deeplog_test)
